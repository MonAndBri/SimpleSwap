...
contract SimpleSwap {
    ...
    /// @dev Transfers withdrawn token amounts to the user
    ...
    /// @dev Uses the Babylonian method, bounded to a fixed number of iterations
    /// @param x Input value
    /// @return y The floor square root of the input
